...
public class IngestQuarterlyProfitsData {

	DatabaseConnectionFactory dcf = null;	
	private String table_name = "investmentportfolio.quarterlyprofits";
	
	IngestQuarterlyProfitsData(ArrayList<FinancialData> data) {
		...
		for(FinancialData d:data) {
			...
			if(flag == false) {
				...
				ArrayList<String> q_profits_present = d.currentYearQuarterlyProfits;
				ArrayList<String> q_profits_previous = d.previousYearQuarterlyProfits;
				
				String present_q1 = q_profits_present.get(1);
				String present_q2 = q_profits_present.get(2);
				String present_q3 = q_profits_present.get(3);
				String present_q4 = q_profits_present.get(4);
				
				String previous_q1 = q_profits_previous.get(1);
				String previous_q2 = q_profits_previous.get(2);
				String previous_q3 = q_profits_previous.get(3);
				String previous_q4 = q_profits_previous.get(4);
